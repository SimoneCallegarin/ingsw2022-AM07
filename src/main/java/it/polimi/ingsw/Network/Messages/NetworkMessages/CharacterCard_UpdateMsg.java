...
public class CharacterCard_UpdateMsg extends NetworkMessage{
    ...
    public CharacterCard_UpdateMsg(MessageType messageType, int characterCardId, int playerID, int generalReserve, int playerMoney, int denyCards, HashMap<RealmColors,Integer> studentsOnCharacter) {
        super(messageType);
