...
public class DiningStudentsPanel extends JPanel {
    ...
    /**
     * Initializes this panel with the ModelStorage information about the students placed in the dining game object.
    ...
    /**
     * Removes all the students from the dining in order for the
     * InitializeDiningStudents to draw the students on an empty panel.
     */
    ...
    /**
     * Sets students clickable in order for the minstrel effect to activate.
    ...
    /**
    * Removes the mouseListeners from the students button drawn in the dining.
     */
