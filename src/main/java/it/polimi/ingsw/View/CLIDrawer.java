...
public class CLIDrawer {
    ...
    private void drawDashboard(int playerID) {
        ...
        char playerIDChar = '0';
        if(playerID==0){    startingPointX=1;  startingPointY=3;    playerIDChar='0';   }
        if(playerID==1){    startingPointX=1;  startingPointY=TABLE_DIMENSION_Y-23;   playerIDChar='1';   }
        if(playerID==2){    startingPointX=14;  startingPointY=3;   playerIDChar='2';   }
        if(playerID==3){    startingPointX=14;   startingPointY=TABLE_DIMENSION_Y-23; playerIDChar='3';   }
        ...
        gameTable[startingPointX+1][startingPointY+14] = playerIDChar;
    ...
    private void drawIsle(int posX, int posY) {
        /*
        ╔═══════════╗
        ║  ISLE_N   ║
        ║ 5-5-5-5-5 ║
    ...
    private void drawIsles() {
        for(int i=0; i<game.getGameTable().getIsleManager().getIsles().size(); i++){
            if(i<5)
                drawIsle(3,25+13*i);
            if(i==6||i==11)
                drawIsle(10,25+13*(i-6));
            if(i>5 && i!=11)
                drawIsle(17,40+13*(i-7));
        }
    }
