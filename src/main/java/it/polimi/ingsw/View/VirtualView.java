...
public class VirtualView implements ModelObserver {
    ...
    public void onGameCreation(int numPlayers, ArrayList<String> nicknames, GameMode gameMode, int whereMNId, ArrayList<HashMap<RealmColors,Integer>> entrances, ArrayList<HashMap<RealmColors, Integer>> clouds, ArrayList<HashMap<RealmColors,Integer>> isleStudents, ArrayList<HashMap<RealmColors, Integer>> studentsOnCharacter, ArrayList<Integer> numTowers, int money, int generalReserve, ArrayList<TowerColors> towerColors, ArrayList<String> characterNames, ArrayList<Integer> characterCost, ArrayList<Integer> denyCards) {
        ...
        broadcastMessage(gameCreation_updateMsg);
    }
    ...
    public void onGamePhases(int activePlayer, GamePhases gamePhases, ActionPhases actionPhases, int winner) {
        ...
        broadcastMessage(gamePhase_updateMsg);
    }
    ...
    public void onAssistantCard(int idPlayer, int turnOrderPlayed, int movementMNPlayed, ArrayList<Integer> turnOrdersAvailable, ArrayList<Integer> movementsMNAvailable) {
        ...
        broadcastMessage(assistCard_updateMsg);
    }
    ...
    public void onStudentMoving_toDining(int idPlayer, HashMap<RealmColors, Integer> entrance, HashMap<RealmColors, Integer> dining) {
        ...
        broadcastMessage(studentToDining_updateMsg);
    }
    ...
    public void onProfessorUpdate(ArrayList<HashMap<RealmColors,Integer>> professors) {
        ...
        broadcastMessage(professor_updateMsg);
    }
    ...
    public void onStudentMoving_toIsle(int idPlayer, HashMap<RealmColors, Integer> entrance, int isleID, HashMap<RealmColors, Integer> isleStudents) {
        ...
        broadcastMessage(studentToIsle_updateMsg);
    }
    ...
    public void onMNMovement(int idPlayer, int isleId, ArrayList<HashMap<RealmColors, Integer>> isleStudents, ArrayList<Integer> numIsles) {
        ...
        broadcastMessage(mnMovement_updateMsg);
    }

    @Override
    public void onCloudUpdate(int playerId,HashMap<RealmColors, Integer> entrance, int cloudId) {
        PickFromCloud_UpdateMsg pickFromCloud_updateMsg =new PickFromCloud_UpdateMsg(MessageType.CLOUDCHOICE_UPDATE,playerId,entrance,cloudId);
        broadcastMessage(pickFromCloud_updateMsg);
    }
    ...
    public void onCharacterCard(int characterCardId, int idPlayer, int generalReserve, int playerMoney, int denyCards, HashMap<RealmColors,Integer> studentsOnCharacter) {
        ...
        broadcastMessage(characterCard_updateMsg);
    }
    ...
    public void onDenyCard(int playerId, int isleId, boolean denyCard) {
        ...
        broadcastMessage(denyCard_updateMsg);
    }
    ...
    public void onFillCloud(ArrayList<HashMap<RealmColors, Integer>> clouds) {
        ...
        broadcastMessage(fillCloud_updateMsg);
    }
